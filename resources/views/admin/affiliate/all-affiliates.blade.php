        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Affiliate Information</h5>
    ...
    <div class="container mt-5">
        ...
        <div class="row bg-white mx-1">
            <div class="col-12">
                ...
                <h2 class="">Affiliate Information</h2>
                ...
                <table class="table table-striped" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> 
                            <a href="/admin/export-csv/{{ $members->id }}" class="btn btn-success" 
                            ...
                            <a href="/admin/export-pdf/{{ $members->id }}" class="btn btn-danger" 
...
$(document).ready(function() {
    $(".delete").click(function(event) {
        ...
        if (data == true) {
            ...
            $.ajax({
                type: "DELETE",
                url: "/admin/delete-affiliate/" + datas,
                headers: {
...
$(document).ready(function() {
    $(".views").click(function(event) {
        ...
        $.ajax({
            type: "GET",
            url: "/admin/single-affiliate/" + datas,
            success: function(data) {
